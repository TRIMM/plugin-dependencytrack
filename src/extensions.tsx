...
export const EntityDependencytrackSummaryCard = dependencytrackPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () =>
        import('./components/DependencytrackCard').then(({ DependencytrackSummaryCard }) => {
          const Dependencytrack = ({ tableOptions }: DependencytrackPageProps) => {
...
export const EntityDependencytrackFindingCard = dependencytrackPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () =>
        import('./components/DependencytrackCard').then(({ DependencytrackFindingCard }) => {
          const Dependencytrack = ({ tableOptions }: DependencytrackPageProps) => {
            const { entity } = useEntity();
            return (
    ...
    component: () =>
      import('./components/DependencytrackCard').then(({ DependencytrackFindingCard }) => {
        const DependencytrackPage = (props: DependencytrackPageProps) => {
          ...
          return <DependencytrackFindingCard entity={entity} tableOptions={tableOptions} />;
        };
